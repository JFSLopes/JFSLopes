...
| Interactive Computer Graphics (SGI) | ThreeJS Scenes (Bucket Shot & Underwater) | Developed interactive 3D scenes using Three.js, including a physics-inspired bucket shot scene and a detailed underwater environment with lighting, textures, shaders, and animations. | PW1: 19.9/20 · PW2: 18.5/20 | [Repository](https://github.com/JFSLopes/sgi-2025-2026-threejs) |
...
| Advanced Data Structures and Algorithms | Multigraph Explorer | Built a multimodal routing prototype and benchmarked shortest-path algorithms, priority queues, graph coloring, and Quadtree spatial indexing. | 20/20 | [Repository](https://github.com/JFSLopes/EDAA) |
